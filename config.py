...
# ───── User Settings ───── #
FREE_ORDERS_DAILY_LIMIT = int(getenv("FREE_ORDERS_DAILY_LIMIT", 5))
...
CHANNEL_BUTTONS = {
    ...
    "SERVICES_UPDATE": {"name": "🏪 SERVICES UPDATE", "url": "https://t.me/SmmBoosterz"},
    "COINS_CHANNEL": {"name": "🪙 COINS STORE", "url": "https://t.me/Freenethubchannel"}
}
